"""Switch platform for integration_rclone."""
...
class IntegrationRcloneSwitch(IntegrationRcloneEntity, SwitchEntity):
    """integration_rclone switch class."""
